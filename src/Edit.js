...
function Edit(props) {
    ...
    return (
        <div>
            <Button color="info" onClick={toggle}>Edit ♂️</Button>
            <Modal isOpen={enable} toggle={toggle} >
                <ModalHeader toggle={toggle}><span>🏝️</span> Change the form </ModalHeader>
                <ModalBody>
                    <Label >Name: </Label>{' '}
                ...
                <ModalFooter>
                    <Button color="primary" onClick={createButtonHandler}>Change the task <span>🐶</span></Button>{' '}
